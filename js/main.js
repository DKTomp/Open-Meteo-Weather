async function generalData() {
    try {
        let weatherResponse = await fetch (`https://api.open-meteo.com/v1/forecast?latitude=33.45&longitude=-96.38&current=temperature_2m,wind_speed_10m,wind_direction_10m,wind_gusts_10m,cloud_cover,pressure_msl,apparent_temperature,relative_humidity_2m,precipitation&&wind_speed_unit=mph&temperature_unit=fahrenheit&precipitation_unit=inch`)
...
function svgIcon(cvr) {
    cloudImg = document.getElementById("sky-cond")
    if (cvr >= 88) {
